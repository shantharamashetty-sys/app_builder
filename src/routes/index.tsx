 ...
 * modules 03, 06-22 are implemented, add their routes below rather than
 * introducing routing logic anywhere else in the app. Auth routes (Module
 * 02) and the AI App Generation flow (Module 04) render full-screen outside
 * AppLayout — they own their own minimal chrome with no sidebar.
 */
